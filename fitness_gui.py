...
# Load file with trained model and label encoder
clf = joblib.load("fitness_pipeline.pkl")
label_enc = joblib.load("label_encoder.pkl")

#function asking user to input fitness goal eg "lose fat" and fitness level eg: "beginner"
...
##GUI for question "Enter Ftness Level"
